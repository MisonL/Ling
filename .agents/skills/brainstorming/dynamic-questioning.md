...
```markdown
[FAIL]  错误提问: "您想要哪种认证方式？"
[OK]  正确提问: "用户应该通过 邮箱/密码 还是 社交登录 进行注册？"
...
```markdown
[FAIL]  错误假设: "用户可能想用 Stripe 处理支付"
[OK]  正确提问: "哪种支付服务商符合您的需求？"
